...
withHQ_Pills=pd.DataFrame({'cases':dfAggByDate,'HQ_Pills':dfAggByDate.values*2})
...
plt.plot(dfAggByDate.index, withHQ_Pills.cases,'r--')
...
plt.plot(dfAggByDate.index, withHQ_Pills.HQ_Pills,'r--')

#Total Number of Pills Needed
cumulative_pills=withHQ_Pills.HQ_Pills.cumsum().tail(120)
...
total_pills=withHQ_Pills.HQ_Pills.cumsum().tail(1)
